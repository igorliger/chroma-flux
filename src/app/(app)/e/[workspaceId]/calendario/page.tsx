...
export default async function CalendarioPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-ink-900">Calendário</h1>
        <p className="mt-1 text-sm text-ink-500">Tarefas do espaço, organizadas por prazo.</p>
      </div>
